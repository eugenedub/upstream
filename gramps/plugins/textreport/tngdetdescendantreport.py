...
"""Reports/Text Reports/TNG Detailed Descendant Report"""
...
#
# ------------------------------------------------------------------------
class TNGDetDescendantReport(Report):
    """Detailed Descendant Report TNG"""
...
# ------------------------------------------------------------------------
#
# TNGDetDescendantOptions
#
# ------------------------------------------------------------------------
class TNGDetDescendantOptions(MenuReportOptions):
    """
